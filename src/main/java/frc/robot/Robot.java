...
public class Robot extends TimedRobot {
  ...
  public Robot() {
    ...
    fdb.SensorToMechanismRatio = 100; // 12.8 rotor rotations per mechanism rotation
  ...
  public void robotPeriodic() {
    ...
    SmartDashboard.putNumber("GetMotorRotorPosition", m_fx.getRotorPosition().getValueAsDouble());
    SmartDashboard.putNumber("Setpoint",getSetPoint());
    SmartDashboard.putNumber("MotorVoltage", m_fx.getMotorVoltage().getValueAsDouble());
