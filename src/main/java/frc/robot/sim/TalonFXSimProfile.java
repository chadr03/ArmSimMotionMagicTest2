...
class TalonFXSimProfile extends SimProfile {
    ...
    public TalonFXSimProfile(final TalonFX talonFX) {
        ...
        this._motorSim = new SingleJointedArmSim(gearbox, 
                                100, 
                                SingleJointedArmSim.estimateMOI(Units.inchesToMeters(20.0), Units.lbsToKilograms(5.0)), 
                                Units.inchesToMeters(20.0), 
                                Units.degreesToRadians(-90.0), 
                                Units.degreesToRadians(270.00), 
                                true, 
    ...
    public void run() {
        ...
        final double position_rot = _motorSim.getAngleRads();
